...
<div id="banner" class="hidden-xs hidden-sm">
    <div class="midcontent">
        <?php if ( get_field( 'glossary_content_banner_image_url_path' ) && get_field( 'glossary_content_banner_image_url_upload' ) ): ?>
...
?>
<?php while ( have_rows( 'glossary_page_breadcrumb' ) ) : the_row(); ?>
<?php
